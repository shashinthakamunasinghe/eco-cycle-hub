# ♻️ Smart Waste Management & Recycling Web App
...
- 🏭 **Industries** can request waste pickups, manage profiles, cancel requests, and track pickup history and status in real time.
- 📊 **Site Admins** can assign collectors (manually/automatically), monitor live collector locations, manage the recycling store, and view analytics.
...
- Role-based authentication and routing using Firebase Auth
