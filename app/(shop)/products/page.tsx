      ...
      <section className="mt-16 py-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg">
        <div className="text-center px-8">
          ...
          <div className="text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Connecting the Circular Economy</h2>
            <p className="text-lg md:text-xl opacity-90 mb-8">From waste to wealth, from industry to customer – we are building a sustainable future together</p>
