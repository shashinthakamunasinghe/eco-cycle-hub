  ...
  try {
    ...
    const samplePickups = [
      ...
      },
      {
        ...
        collectorName: 'John Collector',
        priority: 'high',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 15 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000)),
      ...
      },
      {
        ...
        priority: 'medium',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 20 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 19 * 24 * 60 * 60 * 1000)),
      ...
      },
      {
        ...
        collectorName: 'Sarah Wilson',
        priority: 'low',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 25 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 24 * 24 * 60 * 60 * 1000)),
      ...
      },
      {
        ...
        collectorName: 'John Collector',
        priority: 'high',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 12 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 11 * 24 * 60 * 60 * 1000)),
      ...
      },
      {
        ...
        collectorName: 'Mike Johnson',
        priority: 'medium',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000)),
      ...
      // Add more samples for better analytics
      {
        ...
        collectorName: 'Sarah Wilson',
        priority: 'medium',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000)),
      ...
      },
      {
        ...
        collectorName: 'John Collector',
        priority: 'high',
        requestedAt: Timestamp.fromDate(new Date(now.getTime() - 6 * 24 * 60 * 60 * 1000)),
        completedAt: Timestamp.fromDate(new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000)),
    ...
    for (const pickup of samplePickups) {
      const docRef = await addDoc(collection(db, 'pickupRequests'), pickup);
